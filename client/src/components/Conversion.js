...
function Conversion() {
  ...
  function uploadFile(e){
    e.preventDefault();
    dispatch(FileActions.reqFileUpload())
  }

  function zipFiles(e){
    e.preventDefault();
    dispatch(FileActions.zipFile())
  }
    
  function copyLink(e){
    e.preventDefault();
    console.log('Request to copy link')
  }
  ...
  return (
    <div className='card self-center bg-fuchsia-600 w-1/4 h-40 shadow-lg shadow-gray-400 flex justify-around rounded-lg opacity-100 flex-col animated__animate animate__bounceIn'>
              <div className='flex flex-row justify-around'>
                <div className='self-center flex flex-col justify-around w-32 h-16 bg-orange-400 group hover:ring-white active:translate-y-1 active:bg-white active:ring-white rounded-lg hover:shadow-gray-400 hover:ring-2 active:ring-2 active:shadow-lg' onClick= {(e) => uploadFile(e)}>
                ...
                <div className='self-center flex flex-col justify-around w-32 h-16 bg-orange-400 group hover:ring-white active:translate-y-1 active:bg-white active:ring-white rounded-lg hover:shadow-gray-400 hover:ring-2 active:ring-2 active:shadow-lg' onClick={(e) => zipFiles(e)}>
              ...
              <div className='self-center container flex flex-row'>
                <div className='w-4 h-4 self-center mb-4 ml-6' onClick={(e) => copyLink(e)}>
